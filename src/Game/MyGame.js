...
function MyGame() {
    ...
    // the fonts
    this.kFontCon16 = "src/assets/fonts/Consolas-16";  // notice font names do not need extensions!
    this.kFontCon24 = "src/assets/fonts/Consolas-24";
    this.kFontCon32 = "src/assets/fonts/Consolas-32";  // this is also the default system font
    this.kFontCon72 = "src/assets/fonts/Consolas-72";
    this.kFontSeg96 = "src/assets/fonts/Segment7-96";
